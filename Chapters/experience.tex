...
Now in figure \ref{mob1} and \ref{mob2} you see the rates which are changed whenever producer is changed. This changed is done mannually in this case.
...
\includegraphics[scale = 0.6]{Figures/Load.png}
