...
\subsection{Routing Algorithms Results}

\subsubsection{TreeOnConsumer}
...
\subsubsection{MinCostMultiPath}
...
\includegraphics[scale=0.22]{figures/MaxFlow_big.png} 
\includegraphics[scale=0.21]{figures/maxflow_big.png} 
